...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $loginSql = "SELECT * FROM `registrationp` WHERE username = '$username' AND password = '$password'";
...
.ss{
  ...
  margin-bottom:20px;
    ...
    <body>
       ...
       <form action = "login_signup_pat.php" method = "post" enctype="multipart/form-data">
        <div class="left">
            <div class="centered">
              <img class = "ss"src="26e9ba8f04c5f06c61c27aa2b35bf55e.jpg" alt="Patient" height = 200px width = 200px>
              <h1>Patient LOGIN</h1>
              <p>The Patients are requested to login from here.</p>
              <div class = "login">
              <label for="username"><b>Username</b></label><br>
                ...
                <a href = "http://localhost/js/pat_register.php">Not signed in? Register now</a>
